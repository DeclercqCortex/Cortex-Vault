...
export type UnderlineThickness = "thin" | "medium" | "thick" | "extra-thick";
...
export const CortexUnderlineStyled = Mark.create({
  ...
  addAttributes() {
    return {
      ...
      thickness: {
        ...
        parseHTML: (el) =>
          (el.getAttribute(
            "data-uline-thickness",
          ) as UnderlineThickness | null) ?? null,
        renderHTML: (a: Record<string, unknown>) =>
      ...
      style: {
        ...
        parseHTML: (el) =>
          (el.getAttribute("data-uline-style") as UnderlineStyle | null) ??
          null,
        renderHTML: (a: Record<string, unknown>) =>
  ...
  renderHTML({ HTMLAttributes, mark }) {
    ...
    if (a.thickness)
      styles.push(`text-decoration-thickness: ${THICKNESS_PX[a.thickness]}`);
    ...
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        class:
          "cortex-underline-styled" +
          (a.marching ? " cortex-underline-marching" : ""),
        style: styles.join("; "),
      }),
      0,
    ];
